...
class DotAgent:
    def __init__(self, cursor):
        ...
        self.cur = cursor
        self.num_moves = 0
        self.name = 'players6_0.001.oneFile'
...
def train(db_cursor, state):
    global trained_agents, high_score, plot_scores, plot_avg_scores, total_score, score, num_games, memory
    # get all my dots
    ...
    print(f"\nGame#{num_games} - GORILLAS - Score:{score} - Record:{high_score}")
