...
class Linear_QNET(nn.Module):
    ...
    def save(self, model_num):
        ...
        folder_path = './FinalPlayers/050698203/Model'
...
# get dimensions
configs = None
with open('battleDotsFinal.yml', 'r') as file:
...
class DotAgent:
    def __init__(self, cursor):
        ...
        self.cur = cursor
        self.name = 'FinalPlayers.050698203.gorillasOneFile'
    ...
    # random moves: tradeoff exploration / exploitation
        ...
        #self.epsilon = 0 #50 - randomness # lower for loading better models
...
def train(db_cursor, state):
    ...
    for row in all_rows:
        if trained_agents:  # use existing agent
            ...
            dotAgent.model.load(603)



        if 1: #dotAgent.check_if_food():
            # get old state
    ...
    #num_moves += 1
    #print(f"GORILLAS - Score:{score} - Record:{high_score}")
